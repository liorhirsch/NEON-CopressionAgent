...
class MaskedLinearPreTrained(nn.Module):
	def __init__(self, in_d, out_d, weights_params, bias_params):
		super(MaskedLinearPreTrained, self).__init__()
		self.weight = weights_params
