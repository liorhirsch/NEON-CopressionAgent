...
def MaskedResNet18():
    return MaskedResNet(BasicBlock, [2, 2, 2, 2])

def MaskedResNet34():
    return MaskedResNet(BasicBlock, [3, 4, 6, 3])

def MaskedResNet50():
    return MaskedResNet(Bottleneck, [3, 4, 6, 3])

def MaskedResNet101():
    return MaskedResNet(Bottleneck, [3, 4, 23, 3])

def MaskedResNet152():
    return MaskedResNet(Bottleneck, [3, 8, 36, 3])
