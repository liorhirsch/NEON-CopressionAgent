...
from .network.masked_modules import MaskedLinear, MaskedConv2d, MaskedLinearPreTrained
...
def is_masked_module(m):
	if isinstance(m, MaskedLinear) or isinstance(m, MaskedConv2d) or isinstance(m, MaskedLinearPreTrained):
		return True
	else:
		return False
